...
void SetTheme() {
    ...
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.37f, 0.37f, 0.37f, 0.37f);
    ...
    colors[ImGuiCol_CheckMark]              = ImVec4(1.00f, 0.69f, 0.00f, 1.00f);
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.51f, 0.51f, 0.51f, 1.00f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.86f, 0.86f, 0.86f, 1.00f);
    colors[ImGuiCol_Button]                 = ImVec4(0.44f, 0.44f, 0.44f, 0.40f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.77f, 0.49f, 0.00f, 1.00f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.42f, 0.42f, 0.42f, 1.00f);
    colors[ImGuiCol_Header]                 = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.77f, 0.49f, 0.00f, 1.00f);
    ...
    colors[ImGuiCol_TabHovered]             = ImVec4(1.00f, 0.64f, 0.00f, 1.00f);
    colors[ImGuiCol_TabActive]              = ImVec4(0.77f, 0.49f, 0.00f, 1.00f);
