...
inline bool gIsDXGIFormatSRGB(DXGI_FORMAT inFormat)
{
    switch (inFormat)
    {
        case DXGI_FORMAT_R8G8B8A8_UNORM_SRGB:
...
inline DXGI_FORMAT gDXGIFormatToSRGB(DXGI_FORMAT inFormat)
{
    assert(!gIsDXGIFormatSRGB(inFormat));
...
inline DXGI_FORMAT gDXGIFormatFromSRGB(DXGI_FORMAT inFormat)
{
    assert(!gIsDXGIFormatSRGB(inFormat));
